...
// CreateZoneRequest is the body for POST /api/v1/zones (admin only)
...
// UpdateZoneRequest is the body for updating a zone (admin only).
...
// ZoneResponse represents a zone with the dynamically calculated available_spots.
